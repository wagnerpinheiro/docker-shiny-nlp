...
The image is available from [Docker Hub](https://registry.hub.docker.com/u/wagnerpinheiro/docker-shiny-nlp/).
...
```sh
docker run --rm -p 3838:3838 wagnerpinheiro/docker-shiny-nlp
```
...
docker run --rm -p 3838:3838 \
    ...
    wagnerpinheiro/docker-shiny-nlp
```
